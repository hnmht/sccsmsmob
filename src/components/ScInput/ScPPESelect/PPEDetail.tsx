...
const LpDetail = ({ visible, currentItem, backAction,t,theme }:ScDetailProps<ScDataTypeList.PPE>) => {
    return (
        <Portal>
                ...
                <Dialog.ScrollArea style={{ maxHeight: "75%" }} >
                    {currentItem === undefined || currentItem.id === 0
                        ...
                        : <ScrollView style={{ maxHeight: "100%" }}>
                            ...
                            <Text variant="bodyMedium" maxFontSizeMultiplier={1.4} selectable>{t("ppeModel")} : {currentItem.model}</Text>
                            <Text variant="bodyMedium" maxFontSizeMultiplier={1.4} selectable>{t("ppeUnit")} : {currentItem.unit}</Text>
