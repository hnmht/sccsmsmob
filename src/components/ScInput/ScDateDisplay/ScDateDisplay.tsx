...
import ScDateDetail from "../ScDateInput/ScDateDetail";

//308 Seacloud Date Display Component
const ScDateDisp = (props: ScInputProps<ScDataTypeList.DateDisp>) => {
    const {
        positionID = 0,
        rowIndex = 0,
        allowNull = true,
    ...
    const content = isEpoch ? "" : DateTimeFormat(initValue, "LL");
...
export default memo(ScDateDisp);
